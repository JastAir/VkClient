...
import com.fdev.vkclient.background.longpoll.receivers.RestarterBroadcastReceiver
...
import com.fdev.vkclient.crypto.prime.PrimeGeneratorJobIntentService
import com.fdev.vkclient.crypto.prime.PrimeGeneratorService
                    ...
                    context?.sendBroadcast(Intent().apply {
                        ...
                        if (bitmap != null) {
                            ...
                            putExtra(EXTRA_SHORTCUT_ICON_RESOURCE,
                                    ShortcutIconResource.fromContext(context, R.drawable.app_logo))
                        }
